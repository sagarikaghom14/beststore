pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://localhost:8082/manager/text' // URL for Tomcat Manager's text interface
            ...
            steps {
                script {
                    ...
                    if (fileExists(WAR_FILE)) {
                        ...
                        // Deploy the WAR file to Tomcat using the corrected URL and parameters
                        bat """
